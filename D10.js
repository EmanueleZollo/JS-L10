...
*/
const makingSum = function (n1,n2) {
let sum = n1 + n2;
return sum
} 

console.log(makingSum(10, 20));
...
console.log(splitMe("Se lo sapessi sussulterei"));
...
const deleteOne = function (str, booleano) {
  if (booleano === true) {
    let trueArray = str.split('')
    trueArray.shift()
    return trueArray.join('')
  } else {
    let falseArray = str.split('')
    falseArray.pop() 
    return falseArray.join('')
  }
}

console.log(deleteOne("Sbagliato", false));
...
// let BigEx = ["c"," ","i","a","2"]
// let verify = parseInt(BigEx[4])
// console.log("esempio:" + verify);
...
const onlyLetters = function (str) {
  ...
  // let noNumArray = array.join('')
  // return noNumArray
}

console.log( onlyLetters("Ci sono 2 serpenti, 1 orangotango"));
...
const isThisAnEmail = function (str) {
  if (str.includes("@") && str.includes(".") === true ) {
  return true
} else {
  return false
}
...
console.log(isThisAnEmail("Ciao@scioccait"));
...
const whatDayIsIt = function () {
 ...
 let currentDay = new Date('July 14, 2023')
...
const rollTheDices = function (num) {
  for (let i=0; i < num; i++) {
    diceNum = dice();
    diceRoll.sum += diceNum
    diceRoll.values.push(diceNum)
  }
  return diceRoll
}
...
console.log(deleteProp({name:"Toni", professione: "calciatore", "titolo di studio": "laurea", stato: "celibe"},"titolo di studio"));
...
const newestMovie = function () {
  // for (let i = 0; i < movies.length; i++) {
    for (let i = 0; i < movies.length; i++) {
     let integer = parseInt(movies[i].Year)
      movies[i].Year = integer
      index = Math.max(integer)
    }
    arrayIndex = movies.findIndex(((holyS) => holyS.Year === 2019)) 
    return movies[arrayIndex]
      }
